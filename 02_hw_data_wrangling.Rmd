...
party_incumbent_promote <- na.omit(fb_ads) 
...
fb_top_plot <- ggplot(data = fb_ads, 
                      mapping = aes(x=impressions_millions,y=cand_name_last,fill = party)) + 
  geom_bar(stat = "identity") + labs(x = "Impressions (in Millions)", y = "Candidate Last Name", 
